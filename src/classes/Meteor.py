...
class Meteor(pygame.sprite.Sprite):
	...
	def animate_meteors(self):
		...
		self.image = pygame.image.load(self.images[self.image_index])
		self.clean_image = self.image.copy()  # copy base image for the original orientation and dimensions

	def rotate_meteors(self):
		rotation_tuple = self.rot_center(self.clean_image, self.angle)  # get image center
